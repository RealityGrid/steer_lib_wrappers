...
IF(PERL_EXECUTABLE)
  EXEC_PROGRAM(${PERL_EXECUTABLE}
    ARGS -e "'use Config; print \$Config{installarchlib}, \"\\n\"'"
    OUTPUT_VARIABLE PERL_INCLUDE_OUTPUT_VARIBLE
    RETURN_VALUE PERL_INCLUDE_RETURN_VALUE
  )
  IF(NOT PERL_INCLUDE_RETURN_VALUE)
    FIND_PATH(PERL_INCLUDE_PATH perl.h ${PERL_INCLUDE_OUTPUT_VARIBLE}/CORE)
    SET(PERL_POSSIBLE_LIB_PATHS
      ${PERL_POSSIBLE_LIB_PATHS}
      ${PERL_INCLUDE_OUTPUT_VARIBLE}/CORE
    )
  ENDIF(NOT PERL_INCLUDE_RETURN_VALUE)
